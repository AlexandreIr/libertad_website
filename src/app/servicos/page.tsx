...
export const metadata: Metadata = {
  ...
  description:
    "Conheça os serviços da LCS: facilities, limpeza profissional, portaria, manutenção predial, apoio administrativo e terceirização operacional.",
};
  ...
  return (
    <>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_0.95fr]">
            <div>
              <h1 className="font-heading text-4xl font-black leading-tight tracking-tight text-ink sm:text-5xl">
                Serviços integrados para manter sua operação funcionando com{" "}
                <span className="text-royal">eficiência.</span>
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                Soluções completas em facilities, limpeza, portaria, manutenção
                e apoio administrativo para ambientes organizados, seguros e
                produtivos.
              </p>
              ...
              <div className="mt-7 flex flex-wrap gap-5 text-sm font-semibold text-slate-600">
                <span className="inline-flex items-center gap-2">
                  <Icon name="people" className="h-5 w-5 text-royal" /> Equipes
                  treinadas
                </span>
                <span className="inline-flex items-center gap-2">
                  <Icon name="document" className="h-5 w-5 text-royal" />{" "}
      ...
      <section className="section-y bg-page">
        <Container>
          <SectionHeading
            ...
            description="Soluções completas e integradas para diferentes necessidades do seu negócio."
          />
              ...
              <div className="grid gap-8 md:grid-cols-[0.5fr_1fr] md:items-center">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-2xl leading-7 text-slate-600">
                    Analisamos suas necessidades e desenhamos o plano ideal para
                    sua rotina, seu segmento e o padrão de qualidade esperado
                    pela sua empresa.
                  </p>
                  <Button
                    href="/orcamento"
      ...
      <section className="section-y bg-white">
        <Container>
          <SectionHeading
            title="Por que contratar a LCS?"
            description="Mais eficiência, segurança e tranquilidade para o seu dia a dia."
          />
      ...
      <CTASection
        ...
        text="Fale com um especialista e receba uma proposta sob medida para a sua operação."
      />
    </>
  );
}
