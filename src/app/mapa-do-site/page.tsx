          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                Encontre rapidamente páginas institucionais, soluções por serviço,
                segmentos atendidos e artigos do blog em uma estrutura clara,
                modular e preparada para crescer junto com o site.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-4xl bg-navy p-8 text-white shadow-2xl">
              ...
              <div className="relative">
                ...
                <p className="mt-6 font-heading text-5xl font-black">
                  {totalLinks}
                </p>
                ...
                <p className="mt-5 text-sm leading-6 text-white/75">
                  Esta página consome a mesma fonte de rotas usada pelo sitemap
                  XML, evitando listas duplicadas e reduzindo risco de páginas
                  esquecidas.
                </p>
              </div>
            </div>
          ...
          >
            <span className="flex flex-wrap items-center justify-between gap-3">
              ...
              <span className="flex items-center gap-2">
                ...
                <span className="text-lg font-black text-red transition group-hover:translate-x-1">
                  →
                </span>
              </span>
            </span>
